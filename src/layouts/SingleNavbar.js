      ...
      <div className="container-fluid">
        ...
        <div className={`collapse navbar-collapse ${isOpen ? "show" : ""}`}>
          ...
          <li className="nav-item dropdown hover-dropdown">
                 <a className="nav-link" href="/QuizSingleNotice">Notice</a>
            </li>
            <li className="nav-item dropdown hover-dropdown">
                 <a className="nav-link" href="/QuizSingleAttendance">Attendance</a>
            </li>
            <li className="nav-item dropdown hover-dropdown">
                 <a className="nav-link" href="/QuizSingleFeedback">Feedback</a>
            </li>
            <li className="nav-item dropdown hover-dropdown">
                 <a className="nav-link" href="/QuizSingleResult">Quiz Result</a>
            </li>
            <li className="nav-item dropdown hover-dropdown">
